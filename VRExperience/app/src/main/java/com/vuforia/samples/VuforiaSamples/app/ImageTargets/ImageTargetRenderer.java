...
import com.vuforia.samples.SampleApplication.utils.OBJ_Loader;
...
import com.vuforia.samples.SampleApplication.utils.Model1;
import com.vuforia.samples.SampleApplication.utils.Model;
import com.vuforia.samples.SampleApplication.utils.Texture;

import app.lutec.vrexperience.GUI.GL_utils.RawResourceReader;
import app.lutec.vrexperience.GUI.GL_utils.ShaderHelper;
import app.lutec.vrexperience.GUI.GL_utils.TextureHelper;
import app.lutec.vrexperience.GUI.MainActivity;
import app.lutec.vrexperience.GUI.obj.VBO_Loader;
...
public class ImageTargetRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        model = new Model1();
        try{
            InputStream file = mActivity.getAssets().open("Thorne1.obj");
            //final File dir = new File(mActivity.getFilesDir() +"src/main/assets");
            //dir.mkdir();
            model = VBO_Loader.loadModel(file);
            model.loadVBO();
        ...
        // Load the texture
        mAndroidDataHandle = TextureHelper.loadTexture(mActivity, R.drawable.texture);
...
/*
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            viewMatrix = modelViewMatrix_Vuforia.getData();
    ...
    private void renderScene(){
        ...
        Matrix.translateM(lightModelMatrix, 0, 0.0f,  0.0f, -6.0f);
        ...
        Matrix.translateM(mvpMatrix,0,0.0f,0.0f,6.0f);
        Matrix.scaleM(mvpMatrix,0,6.0f,6.0f,6.0f);
        Log.d("ProjectionMatrix","Model View Matrix:  " + Arrays.toString(mvpMatrix));
        ...
        Matrix.multiplyMM(temporaryMatrix, 0, vuforiaAppSession
                .getProjectionMatrix().getData(), 0, mvpMatrix, 0);
        System.arraycopy(temporaryMatrix, 0, mvpMatrix, 0, 16);
        Log.d("ProjectionMatrix","Model View Projection Matrix:  " + Arrays.toString(mvpMatrix));
        ...
        Log.d("ProjectionMatrix", Arrays.toString(mvpMatrix));
        // Pass in the modelview matrix.
        GLES20.glUniformMatrix4fv(mvMatrixUniform, 1, false, mvpMatrix, 0);
